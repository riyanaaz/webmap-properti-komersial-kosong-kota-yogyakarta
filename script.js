...
// 2.1. Definisikan Layer Google Maps
...
const osmMap = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    maxZoom: 19, 
    attribution: '© OpenStreetMap | Riyana Ajizah - S1 Teknik Geodesi UGM'
});
...
function setupDropdowns() {
    ...
    function renderJalan(filter = '') {
        ...
        if (arr.length === 0) {
            ...
            div.style.alignItems = 'flex-start'; // Agar icon error tetap di atas saat teks jadi 2 baris
            // Tambahkan white-space: normal agar teks bisa turun ke bawah
            div.innerHTML = `<i class="fas fa-exclamation-circle" style="color: #ccc; margin-top: 2px;"></i> <span class="dropdown-text" style="white-space: normal; line-height: 1.4;">Data tidak tersedia atau tidak ada properti kosong.</span>`;
    ...
    function renderJenis(filter = '') {
        ...
        if (arr.length === 0) {
            ...
            div.style.fontStyle = 'italic';
            div.style.cursor = 'default';
            div.style.alignItems = 'flex-start'; // Agar icon error tetap di atas
            // Tambahkan white-space: normal agar teks bisa turun ke bawah
            div.innerHTML = `<i class="fas fa-exclamation-circle" style="color: #ccc; margin-top: 2px;"></i> <span class="dropdown-text" style="white-space: normal; line-height: 1.4;">Data tidak tersedia atau tidak ada properti kosong.</span>`;
